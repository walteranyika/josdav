...
import adefault.ubuntu.josdav.josdav.adapters.RecyclerAdapter;

/**
 * Created by android on 7/18/2016.
 */
public abstract class Ponds extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        recyclerAdapter = new RecyclerAdapter(mPondList, getActivity());
